      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            >
              <span className="w-8 h-8 rounded-full bg-brand-primary flex items-center justify-center">
            ...
            <div className="flex items-center gap-3" aria-label="Social media links">
              ...
              <a
                href="https://facebook.com/baghekhas"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-brand-secondary transition-colors duration-200"
                aria-label="Facebook"
            ...
            <ul className="flex flex-col gap-4" role="list">
              <li>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0 text-brand-secondary" aria-hidden="true" />
              ...
              <li>
                ...
                >
                  <Phone className="w-4 h-4 flex-shrink-0 text-brand-secondary" aria-hidden="true" />
                  <span>+92 300 123 4567</span>
                </a>
              </li>
              <li>
                <a
                  href="mailto:hello@bagh-e-khas.com"
                  className="flex items-center gap-3 text-sm text-gray-400 hover:text-white transition-colors duration-200"
                >
                  <Mail className="w-4 h-4 flex-shrink-0 text-brand-secondary" aria-hidden="true" />
                  <span>hello@bagh-e-khas.com</span>
                </a>
              </li>
            </ul>
          </div>
